...
- **비디오 회전 옵션** - 출력 영상을 90°, 180°, 270°(시계방향) 회전. 앞/뒤 공백 옵션 옆에서 선택하며 큐의 모든 파일에 일괄 적용. 90°/270° 회전 시 출력 해상도와 인코더 level이 자동 조정되고, 검정 패드 프레임도 회전 후 크기에 맞춰 생성

## [1.1.6] - 2026-04-16

### 변경

- **공백 옵션 기본값 변경** - 앞 공백은 기본 해제, 뒤 공백은 기본 체크(1초)
- **Linux FFmpeg 빌드를 BtbN 으로 교체** - johnvansickle 정적 빌드에 없던 NVENC/QSV/VAAPI/AMF HEVC 인코더 포함
- **README 보강** - 리눅스 설치 가이드 및 배포판별 하드웨어 가속 드라이버 패키지 안내 추가

## [1.1.5] - 2026-04-16

### 추가

- **뒤 공백 옵션** - 인코딩된 영상 끝에 1-3초의 무음 검정 프레임 추가. 기존 "앞 공백" 옵션과 동일한 형태로 동작
